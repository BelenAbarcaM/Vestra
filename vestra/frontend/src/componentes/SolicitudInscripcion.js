...
export default function SolicitudInscripcion({ club, onVolver }) {
  ...
  return <section className="solicitud-page"><article className="solicitud-card">
    ...
    <header className="solicitud-heading">
      <span className="solicitud-chip">SOLICITUD DE INSCRIPCIÓN</span>
      <h1>Solicitud de inscripción para el club</h1>
      <p>Completa tus datos para solicitar un espacio en <strong>{club?.Nombre || 'el club'}</strong>.</p>
    </header>
      {enviada ? <div className="solicitud-ok" role="status">
